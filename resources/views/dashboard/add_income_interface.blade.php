		...
		<div class="col-md-12 ">
			...
			<div class="box box-primary" >
				<div class="box-header with-border">
					<h3 class="box-title">Add Income Information</h3>
...
var formData= new FormData();
formData.append("income_name",expense_name);
formData.append('income_amount',expense_amount);
formData.append('comment',comment);
formData.append('income_date',expense_date);
...
//alert(expense_name);
	...
	processData: false,
	contentType: false,
	url:"{{url('save_income_information')}}",
	type:'POST',
	data: formData,
	success:function(data, status){
