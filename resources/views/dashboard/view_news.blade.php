          ...
          <ul class="timeline">
            ...
            <li>
              ...
              <div class="timeline-item">
                <span class="time"><i class="fa fa-clock-o"></i> {{$news->date}}</span>

                

                <div class="timeline-body">
                  
                  <h3 style="color:red">{{$news->title}}</h3>
                  <p>{{$news->news}}</p>


                   <img height="20%" width="20%" src="{{asset('sazid_school/news_image')}}/{{$news->image}}" alt="..." class="margin">

                </div>
                <div class="timeline-footer">
                  <!--<button class="btn btn-primary btn-xs" onclick="GetUserDetails({{$news->id}})">Edit</button>-->
                  <button class="btn btn-danger btn-xs" onclick="delete_data({{$news->id}})">Delete</button>
                </div>
              </div>
            </li>
