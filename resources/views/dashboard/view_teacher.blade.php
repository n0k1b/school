          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody id ="records_content">
                     ...
                     <td>
                    <button onclick="GetUserDetails({{$teacher->id}})" class="btn btn-success ">Edit</button>
                </td>
               <td>
                    <button onclick="delete_data({{$teacher->id}})" class="btn btn-danger ">Delete</button>
                </td>
  ...
  $("#hidden_user_id").val(id);
    ...
    formData.append('id',id);
     ...
     $.ajax({
      processData: false,
      contentType: false,
      url:"{{url('show_update_modal_teacher')}}",
      type:"POST",
      data:formData,
      success:function(data,status){
