        ...
        <div class="modal-body">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input type="text" name="update_marks_ct" id="update_marks_ct" placeholder="Obtaining Marks CT" class="form-control">
          </div>
  ...
  <div class="col-md-12 ">
    ...
    <div class="box box-primary" >
      <div class="box-header with-border">
        <h3 class="box-title">View Term Exam Marks</h3>
        <br>
        <br>
...
<script>
 ...
 function GetUserDetails(id){
     ...
     $.ajax({
      ...
      success:function(data,status){
       ...
       var user = JSON.parse(data);
        ...
        $("#update_marks_ct").val(user.obtaining_marks_ct);
  ...
  function UpdateUserDetails() {
    ...
    var update_marks_ct = $("#update_marks_ct").val();
   ...
   var formData= new FormData();
    ...
    formData.append('update_marks_ct',update_marks_ct);
