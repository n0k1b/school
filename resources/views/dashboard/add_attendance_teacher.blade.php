    ...
    <div class="col-md-12 ">
      ...
      <div class="box box-primary" >
        <div class="box-header with-border">
          <h3 class="box-title">Add Attendance Teacher</h3>
 ...
 $.ajaxSetup({
  ...
  formData.append("attendance_date",attendance_date);
    ...
    $.ajax({
      processData: false,
      contentType: false,
      url:"{{url('submit_teacher_attendance')}}",
      type:'POST',
      data: formData,
...
formData.append('class',class_name);
  ...
  $("#show").click(function(){
    ...
    $.ajax({
      processData: false,
      contentType: false,
      url:"{{url('add_teacher_attendance')}}",
      type:"POST",
      data:formData,
      success:function(data,status){
        var msg=$.trim(data);
