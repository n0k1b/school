...
<div class="content-wrapper">
 ...
 <div class="modal fade" id="update_complain_modal">
    <div class="modal-dialog">
      <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="send_complain()" >Send</button>
        <input type="hidden" id="hidden_user_id">
      </div>
        ...
        <div class ="row">
          <form method="post" action="">
            <div class = "col-md-2">
						...
						<p  style="float:right;margin-right:30px">Total Student: <span id="total"></span></p>
...
<script>
   function send_complain()
   {
    ...
    $.ajax({
      processData: false,
      contentType: false,
      url:"{{url('send_complain')}}",
      type:'POST',
      data: formData,
      success:function(data, status){

     alert("Complain send successfully");
     fetch_data();
  },
...
//     });
   ...
   $("#update_complain_modal").modal("show");
