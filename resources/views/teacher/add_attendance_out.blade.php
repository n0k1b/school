...
<script>
  ...
  var class_name = $("#class_name").val();
    ...
    $.ajax({
      processData: false,
      contentType: false,
      url:"{{url('present_check_teacher_out')}}",
      type:'POST',
      data: formData,
...
function absent_check(id)
{
  ...
  $.ajax({
    processData: false,
    contentType: false,
    url:"{{url('absent_check_teacher_out')}}",
    type:'POST',
    data: formData,
...
//   formData.append("school_id",school_id);
  ...
  formData.append("attendance_date",attendance_date);
    ...
    $.ajax({
      processData: false,
      contentType: false,
      url:"{{url('submit_attendance_teacher_out')}}",
      type:'POST',
      data: formData,
...
formData.append('class',class_name);
  ...
  $("#show").click(function(){
    ...
    //alert(class_name+" "+school_id+" "+section);
    ...
    $.ajax({
      processData: false,
      contentType: false,
      url:"{{url('add_attendance_teacher_out')}}",
      type:"POST",
      data:formData,
      success:function(data,status){
        var msg=$.trim(data);
