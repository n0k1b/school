...
<div class="content-wrapper" style="min-height: 622px; padding-top:50px;">
  <!-- Content Header (Page header) -->
  <div class = "row" style="min-height: 622px; padding-top:50px;">
    <div class="col-md-12 ">
...
formData.append('class',class_name);
  ...
  var attendance_date = $("#attendance_date").val();
    ...
    $.ajax({
      processData: false,
      contentType: false,
      url:"{{url('view_attendance_teacher_out')}}",
      type:"POST",
      data:formData,
      success:function(data,status){
        var msg=$.trim(data);
