  ...
  <div class="col-md-12 ">
    ...
    <div class="box box-primary" >
      <div class="box-header with-border">
        <h3 class="box-title">View Expense Information</h3>
        <br>
        <br>
...
<script>
   function fetch_data()
   {
    ...
    $.ajax({
      ...
      contentType: false,
      type:"POST",
      url:"{{url('show_payment_table_account')}}",
   ...
   $("#hidden_user_id").val(id);
    ...
    formData.append('id',id);
     ...
     $.ajax({
      processData: false,
      contentType: false,
      url:"{{url('show_account_update_modal')}}",
      type:"POST",
      data:formData,
      success:function(data,status){
       ...
       var user = JSON.parse(data);
        $("#update_expense_name").val(user.expense_name);
        $("#update_expense_amount").val(user.expense_amount);
   ...
   var formData= new FormData();
    ...
    var conf = confirm("Are you sure");
     if(conf == true) {
      ...
      processData: false,
      contentType: false,
      url:"{{url('delete_account_information')}}",
      type:"POST",
      data:formData,
      success:function(data,status){
  ...
  function UpdateUserDetails() {
   ...
   var formData= new FormData();
    ...
    $.ajax({
      ...
      contentType: false,
       type:"POST",
      url:"{{url('update_account_information')}}",
