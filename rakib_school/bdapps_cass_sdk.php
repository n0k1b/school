...
//
//
//		file_put_contents('input.txt',$jsonRequest);
		...
		//header('Content-type: application/json');    // I have changed this line on 15.03.18 (Arif)
...
class SMSSender  extends Core{
	...
	public static $htext = 'set a username: 
	hey <>set <> username
	send messege:
...
class UssdReceiver{
    ...
    public function __construct(){
		...
		file_put_contents('input.txt',json_encode($array));
